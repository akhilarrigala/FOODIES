...
import './ListFood.css'
import { deleteFood, getFoodList } from '../../components/services/foodService';
...
const ListFood = () => {
  ...
  const fetchList = async () => {
    try {
      ...
      toast.error('Unable to retrieve foods');
    }
  }
  const removeFood = async (foodId) => {
    try {
      ...
      if(success){
       ...
       toast.error('An unexpected error occured while removing the food.')
    }
  }
