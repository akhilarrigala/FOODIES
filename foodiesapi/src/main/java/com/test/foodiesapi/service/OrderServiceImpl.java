...
import com.test.foodiesapi.repository.OrderRepository;
...
public class OrderServiceImpl implements OrderService{
    ...
    public OrderResponse createOrderWithPayment(OrderRequest request) throws RazorpayException {
        ...
        orderRequest.put("amount", (int)(newOrder.getAmount() * 100)); // Convert ₹ to paise
        orderRequest.put("currency", "INR");
        //orderRequest.put("payment_update", 1);
        orderRequest.put("notes", new JSONObject().put("payment_update", "true"));
